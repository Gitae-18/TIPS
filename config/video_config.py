...
class VideoConfig:
    ...
    replay_frames_dir: str = os.getenv("REPLAY_FRAMES_DIR", "./자료/영상자료/03. frames")
    replay_metadata_dir: str = os.getenv("REPLAY_METADATA_DIR", "./자료/영상자료/02. meta_data")
    replay_max_frames: int = int(os.getenv("REPLAY_MAX_FRAMES", "500"))
    replay_fps: float = float(os.getenv("REPLAY_FPS", "10"))
